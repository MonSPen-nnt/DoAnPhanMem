...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaBaoHanh).HasName("PK__BaoHanh__A8DF52E596681B52");
        ...
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A01F6C2743");
        ...
        {
            entity.HasKey(e => e.MaChiTietDonHang).HasName("PK__ChiTietD__4B0B45DDEB8F60FF");
        ...
        {
            entity.HasKey(e => new { e.MaGioHang, e.MaKichCo }).HasName("PK__ChiTietG__98E7737B8F3D4878");
        ...
        {
            entity.HasKey(e => e.MaChucVu).HasName("PK__ChucVu__D46395335141666D");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGiaS__AA9515BF0A6740A9");
        ...
        {
            entity.HasKey(e => e.MaDanhMuc).HasName("PK__DanhMuc__B3750887198CE886");
        ...
        {
            entity.HasKey(e => e.MaDonHang).HasName("PK__DonHang__129584AD703CF4DF");
        ...
        {
            entity.HasKey(e => e.MaGioHang).HasName("PK__GioHang__F5001DA3C5405946");
        ...
        {
            entity.HasKey(e => e.MaHoaDon).HasName("PK__HoaDon__835ED13B2CC37112");
        ...
        {
            entity.HasKey(e => e.MaKichCo).HasName("PK__KichCo__DE76ED871C57AB7D");
        ...
        {
            entity.HasKey(e => e.MaLichSu).HasName("PK__LichSuGi__C443222ADCAFF9E1");
        ...
        {
            entity.HasKey(e => e.MaLichSuGiamGia).HasName("PK__LichSuGi__35BD950F2BDB9F22");
        ...
        {
            entity.HasKey(e => e.MaMauSac).HasName("PK__MauSac__B9A9116244FDC8F5");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__C539D76271D28EB1");
        ...
        {
            entity.HasKey(e => e.MaNhaCungCap).HasName("PK__NhaCungC__53DA9205D791C1C7");
        ...
        {
            entity.HasKey(e => e.MaSanPham).HasName("PK__SanPham__FAC7442D63B6FC93");
        ...
        {
            entity.HasKey(e => e.MaYeuThich).HasName("PK__SanPhamY__B9007E4CEB68741B");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C65295593A449");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B25844034CE320");
        ...
        {
            entity.HasKey(e => e.MaVatLieu).HasName("PK__VatLieu__0A1700AC27C52194");
        ...
        {
            entity.HasKey(e => e.MaVoucher).HasName("PK__VOUCHER__0AAC5B111D492DDB");
