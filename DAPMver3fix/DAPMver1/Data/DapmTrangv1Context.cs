...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ZINHDEPTRAI\\SQLEXPRESS;Initial Catalog=DAPM_Trangv1;Integrated Security=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BaoHanh>(entity =>
        {
            entity.HasKey(e => e.MaBaoHanh).HasName("PK__BaoHanh__A8DF52E55B63A30B");
        ...
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A068561B27");
        ...
        {
            entity.HasKey(e => e.MaChiTietDonHang).HasName("PK__ChiTietD__4B0B45DDEB41BAF7");
        ...
        {
            entity.HasKey(e => new { e.MaGioHang, e.MaKichCo }).HasName("PK__ChiTietG__98E7737B639FFBC5");
        ...
        {
            entity.HasKey(e => e.MaChucVu).HasName("PK__ChucVu__D463953334399CF7");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGiaS__AA9515BFEBA50A9D");
        ...
        {
            entity.HasKey(e => e.MaDanhMuc).HasName("PK__DanhMuc__B37508870AAD08F4");
        ...
        {
            entity.HasKey(e => e.MaDonHang).HasName("PK__DonHang__129584AD264CE002");
        ...
        {
            entity.HasKey(e => e.MaGioHang).HasName("PK__GioHang__F5001DA3CE40DC89");
        ...
        {
            entity.HasKey(e => e.MaHoaDon).HasName("PK__HoaDon__835ED13B4CB43F2F");
        ...
        {
            entity.HasKey(e => e.MaKichCo).HasName("PK__KichCo__DE76ED874E842E10");
        ...
        {
            entity.HasKey(e => e.MaLichSu).HasName("PK__LichSuGi__C443222A5D6776B9");
        ...
        {
            entity.HasKey(e => e.MaLichSuGiamGia).HasName("PK__LichSuGi__35BD950FA88DCD2C");
        ...
        {
            entity.HasKey(e => e.MaMauSac).HasName("PK__MauSac__B9A911625E0E1C67");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__C539D76293E53CEA");
        ...
        {
            entity.HasKey(e => e.MaNhaCungCap).HasName("PK__NhaCungC__53DA9205669AD1D1");
        ...
        {
            entity.HasKey(e => e.MaSanPham).HasName("PK__SanPham__FAC7442D51256B70");
        ...
        {
            entity.HasKey(e => e.MaYeuThich).HasName("PK__SanPhamY__B9007E4C03447A19");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C65294172D185");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B2584414D42ABB");
        ...
        {
            entity.HasKey(e => e.MaVatLieu).HasName("PK__VatLieu__0A1700ACA91D924F");
        ...
        {
            entity.HasKey(e => e.MaVoucher).HasName("PK__VOUCHER__0AAC5B11CAF54651");
