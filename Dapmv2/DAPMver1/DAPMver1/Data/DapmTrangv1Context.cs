...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ZINHDEPTRAI\\SQLEXPRESS;Initial Catalog=DAPM_Trangv1;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BaoHanh>(entity =>
        {
            entity.HasKey(e => e.MaBaoHanh).HasName("PK__BaoHanh__A8DF52E546AEE34F");
        ...
        {
            entity.HasKey(e => e.MaBinhLuan).HasName("PK__BinhLuan__87CB66A009A70279");
        ...
        {
            entity.HasKey(e => e.MaChiTietDonHang).HasName("PK__ChiTietD__4B0B45DDBC02605A");
        ...
        {
            entity.HasKey(e => new { e.MaGioHang, e.MaSanPham }).HasName("PK__ChiTietG__3AAC69E1B94263F4");
        ...
        {
            entity.HasKey(e => e.MaChucVu).HasName("PK__ChucVu__D4639533BD054656");
        ...
        {
            entity.HasKey(e => e.MaDanhGia).HasName("PK__DanhGiaS__AA9515BFA432CE4E");
        ...
        {
            entity.HasKey(e => e.MaDanhMuc).HasName("PK__DanhMuc__B375088722B2A529");
        ...
        {
            entity.HasKey(e => e.MaDonHang).HasName("PK__DonHang__129584ADC67987C2");
        ...
        {
            entity.HasKey(e => e.MaGioHang).HasName("PK__GioHang__F5001DA30A39E202");
        ...
        {
            entity.HasKey(e => e.MaHoaDon).HasName("PK__HoaDon__835ED13B28AEB9B2");
        ...
        {
            entity.HasKey(e => e.MaKichCo).HasName("PK__KichCo__DE76ED87B152EF1F");
        ...
        {
            entity.HasKey(e => e.MaLichSu).HasName("PK__LichSuGi__C443222A8D458BED");
        ...
        {
            entity.HasKey(e => e.MaLichSuGiamGia).HasName("PK__LichSuGi__35BD950F46E22543");
        ...
        {
            entity.HasKey(e => e.MaMauSac).HasName("PK__MauSac__B9A9116261273526");
        ...
        {
            entity.HasKey(e => e.MaNguoiDung).HasName("PK__NguoiDun__C539D762E374778F");
        ...
        {
            entity.HasKey(e => e.MaNhaCungCap).HasName("PK__NhaCungC__53DA92059E366DEA");
        ...
        {
            entity.HasKey(e => e.MaSanPham).HasName("PK__SanPham__FAC7442D45CCE414");
        ...
        {
            entity.HasKey(e => e.MaYeuThich).HasName("PK__SanPhamY__B9007E4CDE93FEEC");
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C652902C84373");
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B25844E6F0A2A6");
        ...
        {
            entity.HasKey(e => e.MaVatLieu).HasName("PK__VatLieu__0A1700AC23208138");
        ...
        {
            entity.HasKey(e => e.MaVoucher).HasName("PK__VOUCHER__0AAC5B11A24FF0AD");
